...
import com.naren.exceptions.EntityNotFoundException;
import com.naren.model.Sales;
import com.naren.service.SalesService;
...
public class SalesController {
  ...
  // filters documents based on the "storeLocation", groups them by "storeLocation", calculates the
  // total sales and average satisfaction for each store location,
